...
# Get matching codes
MATCHING_CODES=$(psql $(op read op://zoo-shared-platform/prod/SUPABASE_DB_URI) -tA -c "SELECT charge_code FROM vista.charge_codes WHERE charge_code ~ '${CODE_PATTERN_UPPER}' AND closed_date IS NULL ORDER BY charge_code")
